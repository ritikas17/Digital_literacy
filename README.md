...
This repository is my **Digital Literacy Portfolio**, submitted as part of the CSE0001 course at VIT Bhopal University. In this project, I take on the role of a **Student Digital Ambassador** — helping peers navigate the digital world responsibly and professionally.

The portfolio is organized across **five tasks**, each mapping to one module of the course:

| Task | Module | Topic | Marks |
|---|---|---|---|
| Task 1 | Module 1 | Digital Literacy Infographic | 20 |
| Task 2 | Module 2 | Student Digital Portfolio | 20 |
| Task 3 | Module 3 | Coding & Collaboration Platforms | 20 |
| Task 4 | Module 4 | Professional Email & Etiquette Guide | 20 |
| Task 5 | Module 5 | Cybercrime Awareness Case Study | 20 |
...
Completed the beginner-level *"Solve Me First"* challenge in Python 3. This introduced the HackerRank environment, test case validation, and submission workflow.

**Part B – Google Workspace (Google Forms):**
Created a **Digital Literacy Awareness Quiz** with 5 questions for batchmates, including multiple choice and short answer questions. Responses are collected automatically in a linked Google Sheet.

Google Form link:https://docs.google.com/forms/d/e/1FAIpQLSe7h3C1f_AfznvX5sspoUCFkMwf4zRu_AVgtPbwEIGOxLcZWA/viewform?usp=publish-editor
